export {};
// ============================================================
// Lecture 1 — Wrap-up Demo: MOBILE LEGENDS MATCH TRACKER
// ============================================================

// --- UNION TYPES ---
type Role = "tank" | "fighter" | "assassin" | "mage" | "marksman" | "support";
type MatchResult = "win" | "lose" | "draw";
type Rank = "warrior" | "elite" | "master" | "grandmaster" | "epic" | "legend" | "mythic";
...
let lastMatch: [number, number, MatchResult] = [9823741, 18, "win"];
...
function getRankBadge(rank: Rank): string {
...
function announcePlayer(username: string, rank: Rank, isOnline: boolean): void {
...
function draftHero(hero: string, role: Role, banReason?: string): string {
  return banReason
